...
COLLECTION_TOPICS = {
    ...
    "avicultura_intensiva": {
        "description": "Avicultura industrial: broilers, ponedoras, naves, procesado",
        "queries_es": [
            "avicultura intensiva broiler España 2025",
            "naves avícolas ventilación automatización",
            "índice conversión pollo engorde",
            "bioseguridad granjas avícolas industriales",
            "ponedoras industriales Lohmann Hy-Line manejo",
            "incubación artificial pollitos nacedora",
            "integración avícola España Coren Uvesa",
            "procesado avícola matadero calidad",
            "mortalidad pollos engorde prevención",
            "bienestar animal avicultura intensiva normativa",
        ],
        "queries_en": [
            "broiler production efficiency feed conversion",
            "poultry house ventilation automation",
            "laying hen management industrial cage-free",
            "biosecurity poultry farm disease prevention",
            "hatchery incubation technology 2025",
            "poultry processing plant automation",
            "Cobb Ross broiler genetics performance",
            "precision poultry farming sensors",
        ],
    },
    "bodegas_vino": {
        "description": "Enología, viticultura, bodegas de vino y enoturismo",
        "queries_es": [
            "bodegas vino España innovación 2025",
            "viticultura precisión viñedo tecnología",
            "vinificación técnicas enología moderna",
            "variedades uva autóctonas España",
            "denominación origen vino Ribera Rioja Priorat",
            "enoturismo España tendencias",
            "cambio climático viticultura adaptación",
            "vino ecológico biodinámico certificación",
            "crianza barrica roble vino tinto",
            "vendimia mecanizada calidad uva",
        ],
        "queries_en": [
            "Spanish wine industry innovation 2025",
            "precision viticulture vineyard technology",
            "winemaking techniques modern oenology",
            "climate change impact wine production Spain",
            "organic biodynamic wine certification",
            "Tempranillo Garnacha wine grape varieties",
            "wine tourism Spain trends",
            "vineyard management disease prevention",
        ],
    },
}
