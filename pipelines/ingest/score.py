...
_DOMAIN_KEYWORDS: dict[str, list[str]] = {
    ...
    "avicultura_intensiva": [
        "broiler", "pollo de engorde", "nave avícola", "ponedora",
        "incubadora", "nacedora", "incubación", "pollito",
        "cobb", "ross", "hubbard", "aviagen", "lohmann", "hy-line",
        "índice de conversión", "mortalidad", "bioseguridad",
        "ventilación", "calefacción nave", "cortina", "túnel",
        "comedero automático", "bebedero nipple", "cama avícola",
        "procesado", "matadero aves", "desplume", "evisceración",
        "intensivo", "integración avícola", "integradora",
        "industrial poultry", "broiler house", "hatchery",
        "layer cage", "poultry processing",
    ],
    "bodegas_vino": [
        "bodega", "vino", "viñedo", "viticultura", "enología",
        "vinificación", "vendimia", "mosto", "fermentación",
        "barrica", "roble", "crianza", "reserva", "gran reserva",
        "tempranillo", "garnacha", "monastrell", "albariño",
        "verdejo", "godello", "mencía", "bobal", "cariñena",
        "cabernet sauvignon", "merlot", "syrah", "chardonnay",
        "denominación de origen", "DO", "DOCa", "rioja",
        "ribera del duero", "priorat", "rías baixas", "rueda",
        "somontano", "toro", "jumilla", "cava",
        "enoturismo", "cata", "sumiller", "maridaje",
        "poda", "espaldera", "cepa", "sarmiento", "portainjerto",
        "winery", "vineyard", "wine", "oenology", "terroir",
    ],
    "nutricion": [
